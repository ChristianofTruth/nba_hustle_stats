...
p1819 = pd.read_excel('all_playoff_stats.xlsx', sheet_name='stats1819')


franchises = p1819['TEAM'].str.split(' ', n = 1, expand = True)
p1819['Franchise'] = franchises[1]

hustle_and_oppblk = p1819[['TEAM', 'Franchise',
...
app.layout = html.Div(
    [
        html.H2('NBA Hustle and Team Performance Statistics (2018-2019 Playoffs)'),
        html.Div(
            [
